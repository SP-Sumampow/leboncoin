...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/AdFixtures.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/MediaFixtures.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/MessageFixtures.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/ReviewFixtures.php';
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AdFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\MediaFixtures(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\MessageFixtures(), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\ReviewFixtures(), 'groups' => []], 4 => ['fixture' => new \App\DataFixtures\TagFixtures(), 'groups' => []], 5 => ['fixture' => new \App\DataFixtures\UserFixtures(), 'groups' => []]]);
