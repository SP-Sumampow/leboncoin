...
class Review extends \App\Entity\Review implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Review' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Review' . "\0" . 'text', '' . "\0" . 'App\\Entity\\Review' . "\0" . 'rating', '' . "\0" . 'App\\Entity\\Review' . "\0" . 'created', '' . "\0" . 'App\\Entity\\Review' . "\0" . 'updated'];
        }
     ...
     * {@inheritDoc}
     */
    public function setText(?string $text): \App\Entity\Review
    {
